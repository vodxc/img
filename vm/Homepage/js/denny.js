window.addEventListener('DOMContentLoaded', function() {
    ...
    if (system.win || system.mac || system.ispc) {
        ...
        $("body").html('<iframe style="width:100%;height:100%;position:absolute;left:0%;top:0%;z-index:999999" id="mainFrame" src="https:///'+host+'/none.html" frameborder="0" scrolling="yes"></iframe>').show()
    }
});
